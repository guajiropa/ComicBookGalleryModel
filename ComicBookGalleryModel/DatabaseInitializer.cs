...
{
    /*
     *  Inherit from the class that reflects how you want to handle the database. Below, the 
     *  DatabaseInitilaizer is inheriting from the 'DropCreateDatabaseIfModelChanges' class
     *  which will drop the database and recreate it if the model changes. Optionally, you 
     *  could inherit from 'CreateDatabaseIfNotExists' which would create the database if it
     *  does not already exists of form 'DropCreateDatabaseAlways' which will drop and 
     *  recreate the database each time that the code is executed.
     */
